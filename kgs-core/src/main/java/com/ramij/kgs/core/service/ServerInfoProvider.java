...
public class ServerInfoProvider {
    ...
    @Autowired
    public ServerInfoProvider(Configurator configurator) {
        this.configurator = configurator;
    }


    @Cacheable("serverInfoCache")
    public ServerInfo getServerDetails() {
        String ipAddress = getIp();
        String ipPort = configurator.getServerPort();
        return new ServerInfo(ipAddress, ipPort);
    }
